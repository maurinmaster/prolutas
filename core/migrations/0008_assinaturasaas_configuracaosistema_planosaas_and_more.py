# Generated by Django 4.2.7 on 2025-08-28 02:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('core', '0007_remover_modelos_saas'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciclo_pagamento', models.CharField(choices=[('mensal', 'Mensal'), ('anual', 'Anual')], default='mensal', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_suporte', models.EmailField(default='suporte@prolutas.com', help_text='Email de suporte técnico', max_length=254)),
                ('mensagem_manutencao', models.TextField(blank=True, help_text='Mensagem exibida durante manutenção', null=True)),
        ...
        migrations.AddField(
            model_name='academia',
            name='ativa',
            field=models.BooleanField(default=True, help_text='Se a academia está ativa no sistema'),
        ),
        migrations.AddField(
            model_name='academia',
            name='dominio_personalizado',
            field=models.CharField(blank=True, help_text='Domínio personalizado (ex: minhaacademia.com.br)', max_length=100, null=True),
        ),
        migrations.AddField(
            model_name='academia',
            name='slug',
            field=models.SlugField(default='academia-temp', help_text='Identificador único da academia para URLs (ex: academia-santos)', max_length=100, unique=True),
        ),
        migrations.CreateModel(
            name='PagamentoSaaS',
            fields=[
                ...
                ('data_criacao', models.DateTimeField(auto_now_add=True)),
                ('data_atualizacao', models.DateTimeField(auto_now=True)),
                ('assinatura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pagamentos', to='core.assinaturasaas')),
            ],
            options={
